...
export default function AnimeDetails() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            setError(false);
            try {
                const res = await tmdb.get(`/anime/${id}/seasons`);
    ...
    // Pass full episode arrays per season — EpisodeTableHorizontal handles
    // chunking internally (CHUNK_SIZE = 20). Pre-chunking here caused double-
    // splitting, making one season appear as two rows both labeled S1.
